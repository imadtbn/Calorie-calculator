...
function renderShell() {
  ...
  const ui = isEnglish ? {
    ...
    homeAria: 'العودة إلى الصفحة الرئيسية', openNav: 'فتح قائمة التنقل', chooseLanguage: 'اختيار لغة الموقع', arabic: 'العربية', current: 'الحالية', english: 'English', soon: 'تبديل',
